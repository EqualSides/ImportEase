...
const FIELD_COLUMN_META: ColumnMeta[] = [
  ...
  { field: "r1CheckboxType", headerName: "Checkbox Type", editable: false, hide: true },
  ...
  { field: "subGroupAlias", headerName: "Subgroup Alias", editable: true, hide: true },
  ...
  { field: "r1AttributeValueReqFlag", headerName: "Value Required", editable: true, hide: true },
